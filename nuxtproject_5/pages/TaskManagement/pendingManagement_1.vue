<template>
    <div>
        ...
        <div
            v-if="renderCondition === 'Pending_90'"
        >
            <Pending_90/>
        </div>
        <div
