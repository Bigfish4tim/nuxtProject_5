        ...
        >
            ...
            <template v-slot:body.append="{ items }">
                <tr class="bottombody">
                    ...
                    <td>{{ items.map(item => item.use_expense).reduce((prev, curr) => Number(prev) + Number(curr), 0) }}</td>
                    <td>{{ items.map(item => item.document_fee).reduce((prev, curr) => Number(prev) + Number(curr), 0) }}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                </tr>
...
<script>
import InvoiceListFilters from "../../../mixins.js/TaskManagement/invoiceList/InvoiceList/InvoiceListFilters"
import InvoiceListList from "../../../mixins.js/TaskManagement/invoiceList/InvoiceList/InvoiceListList"
