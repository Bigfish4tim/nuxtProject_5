        ...
        >
            ...
            <template v-slot:body.append="{ items }">
                <tr class="bottombody">
                    ...
                    <td>{{ items.map(item => item.difference).reduce(sumReducer, '') }}</td>
                    <td>{{ items.map(item => item.differenceBudget).reduce((prev, curr) => Number(prev) + Number(curr), 0) }}</td>
...
<script>
import AmountChangeFilters from "../../../mixins.js/TaskManagement/resultProcessing/AmountChange/AmountChangeFilters"
import AmountChangeList from "../../../mixins.js/TaskManagement/resultProcessing/AmountChange/AmountChangeList"
